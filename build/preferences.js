...
PreferencesBuilder.prototype.preparePref = function() {
  ...
  // Bug 89: Enable spatial navigation cursor
  this.userPrefs['dom.spatialnavigation.enabled'] = true;
  this.userPrefs['gfx.glcursor.enabled'] = true;

  if (this.config.TARGET_BUILD_VARIANT == 'user') {
    this.userPrefs['marionette.defaultPrefs.enabled'] = false;
  }
