...
GAIA_MAKE_FLAGS += DEVICE_DEBUG=1
endif
...
ifeq ($(ENABLE_KEYPAD),1)
GAIA_MAKE_FLAGS += KEYPAD=1
endif
...
.PHONY: gaia-prefs
gaia-prefs:
	if [ -d $(GAIA_PATH)/../apps ]; then \
	ln -sf $(GAIA_PATH)/../apps $(GAIA_PATH)/; \
	fi
...
ifeq ($(CLEAN_PROFILE), 1)
	...
	$(MAKE) -C $(GAIA_PATH) $(GAIA_MAKE_FLAGS)
	@FOLDERS='webapps'; \
