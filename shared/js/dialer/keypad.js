...
var KeypadManager = {
  ...
  translateKey: function kh_translateKey(key) {
  ...
  keyHandler: function kh_keyHandler(event) {
    ...
    if (event.type == 'keydown' || event.type == 'keyup') {
        key = this.translateKey(event.key);
    ...
    if ((key === '#' || key === '*') && !this._onCall) {
      if (this._phoneNumber === '*#06#' || this._phoneNumber === '*#3228#' || this._phoneNumber === '*#0606#'
              || this._phoneNumber === '*#*#33284#*#*' || this._phoneNumber === '##3424#'
              || this._phoneNumber === '*#8378269#' || this._phoneNumber === '*#*#2637643#*#*' || this._phoneNumber === '*#2886#'
              || this._phoneNumber === '*#573564#' || this._phoneNumber === '*#*#0574#*#*') {
